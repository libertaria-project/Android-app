...
import com.stocksexchange.android.repositories.base.cache.RepositoryCache
 ...
 */
fun <Cache: RepositoryCache, Item : Any> addOrUpdateItemToCache(
    cache: Cache,
    item: Item,
 ...
 * @param saveCache The method that actually saves items in the cache
 */
fun <Cache: RepositoryCache, Item: Any> removeItemFromCache(
    cache: Cache,
    item: Item,
    areItemsPresent: (Cache.() -> Boolean),
    fetchItems: (Cache.() -> List<Item>),
