...
import com.stocksexchange.android.database.model.newd.DatabaseTrade.Companion.TABLE_NAME

/**
 * A Room database model for [Trade] class.
 */
...
data class DatabaseTrade(
    ...
    companion object {
        ...
        const val TABLE_NAME = "new_trades"
