...
/**
 * A ready to use listener to supply to the RecyclerView to get
 * notified about major RecyclerView's events.
 */
class RecyclerViewScrollListener private constructor() : RecyclerView.OnScrollListener() {
    ...
    override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
        if(dy > 0) {
            ...
            if((mLastVisiblePosition == (mTotalItemCount - 1)) &&
                ...
                mStateListener?.onMiddleReached(recyclerView, Directions.DOWNWARDS)
            }
        } else if (dy < 0) {
            ...
            if((mFirstVisiblePosition == 0) &&
                ...
                mStateListener?.onMiddleReached(recyclerView, Directions.UPWARDS)
            }
        }
    }
    ...
    interface StateListener {
        ...
        fun onMiddleReached(recyclerView: RecyclerView, direction: Directions)
