...
/**
 * A custom scroll view with the support for scrolling events
 * as well as the ability to lock and unlock scrolling behavior.
 */
class LockableScrollView @JvmOverloads constructor(
    ...
    /**
     * A flag indicating whether this scroll view is scrollable or not.
     */
    var isScrollable: Boolean = true

    /**
     * A listener to invoke about major scrolling events.
     */
